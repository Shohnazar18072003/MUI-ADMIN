...
const StudentsPage = () => {
    ...
    },
 {
    ...
    },
    {
      ...
      render: (data) => (
        <Space size="middle">
          <Button onClick={()=>editStudent(data)} variant="outlined" color="success" startIcon={<EditIcon />} size="small">
           Edit
          </Button>
          <Button onClick={()=>deleteStudent(data)} variant="outlined" color="error" startIcon={<DeleteIcon />} size="small">
           Delete
          </Button>
        </Space>
      ),
    ...
    <Fragment>
      ...
      <Flex className="filter-box" align="center" justify="right" gap={20}>
        <Select
          ...
          options={options}
        />
        <Button style={{width: '150px', marginLeft:'20px'}} onClick={showModal} variant="contained" color="success">
          Add Student
        </Button>
      </Flex>
      </Flex>
